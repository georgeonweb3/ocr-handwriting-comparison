...
```bash
git clone https://github.com/OmniacsDAO/ocr-handwriting-comparison.git
...
> 🌍 **Code for the commons, powered by \$IACS.**
> Support public-goods innovation: `0x46e69Fa9059C3D5F8933CA5E993158568DC80EBf` (Base)
